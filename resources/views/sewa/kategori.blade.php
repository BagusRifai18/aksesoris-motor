...
<section class="hero is-success is-medium is-bold" style="background-image: url('{{ asset('images/images.jpg') }}'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center center;">
    <div class="hero-body">
        ...
        <table class="table is-fullwidth is-striped is-hoverable">
            <thead>
                <tr>
                    ...
                    <th class="has-text-centered">Id Aksesoris</th>
